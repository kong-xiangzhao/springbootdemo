    ...
    <div class="main">
        <div class="container-fluid">
            ...
            <div class="main-content">
                            ...
                            <div class="card-body">
                                <div class="horizontal-form-elements">
                                    <form class="form-horizontal">
                                        <div class="row">
                                            <input id="addjobplan" type="button" value="新增邮箱"
                                                   class="btn btn-primary m-b-10 m-l-5" data-toggle="modal"
                                                   data-target="#emailAddForm"></input>
                                        </div>
                                    </form><!--/#form-->
                                </div>
                            </div>
                ...
                <div class="row">
                    <!-- 增加邮箱表单（Modal） -->
                    <div class="modal fade" id="emailAddForm" tabindex="1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="true">
                        <div class="modal-dialog" style="width:1000px">
                            ...
                            <div class="modal-content zmf-modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="horizontal-form-elements">
                                        <form class="form-horizontal" id="emailInfoAddForm" role="form">
                                ...
                                <div class="modal-footer">
                                    <input type="button" value="保存" id="saveEmailInfo"  class="btn btn-primary"></input>
...
<!-- bootstrap -->
<script src="emailinfo.js"></script>
</body>

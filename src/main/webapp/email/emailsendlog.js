...
function initTable1() {
    var questUrl=systemPath + "/email/sendlog/search";
    $("#emailSendLogTable").bootstrapTable('destroy').bootstrapTable({
        url: questUrl,
        dataType: 'json',
